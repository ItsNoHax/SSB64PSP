...
palette — is clean and ROM-authored, so root cause is now known to sit
downstream of `ssb-rom`'s mesh/combiner conversion, in pack-time texture
serialization or the PSP runtime texture bind path. Root cause not yet
found for Yoshi, Captain Falcon, Ness, Pikachu, Kirby either. Keep R3
blocked until RE-283 concludes for all of them, in addition to the
