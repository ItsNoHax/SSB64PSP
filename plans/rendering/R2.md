...
`scrshot` of the same node-isolated primitive, clean). Root cause not yet
found for Yoshi, Captain Falcon, Ness, Pikachu, Kirby. Keep R3 blocked until
RE-283 concludes for all of them, in addition to the PSP-1000/coverage items
above.
