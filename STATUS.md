...
- `SSB64_ROM=… cargo test --workspace`: 812 tests pass.
...
- Residual report: 0 suspected bugs, 0 level-0 or padded-addressing
  ...
  177 accept.
- PPSSPPHeadless: all 67 goldens recaptured for RE-315; 27 animated goldens
  refreshed, every other golden unchanged. Repeat captures and captures
  with two zero-padded packs are identical to the shipped-pack capture. The
  eight known-failing goldens are unchanged; see
