...
| RE-319 | Texture buffer rows under 16 bytes are read at the wrong pitch | COMPLETE (PPSSPP software diagnostic and A/B captures, host tests, 44 goldens refreshed; physical PSP not captured) | texture, psp-ge, pack, visual-regression |  |
