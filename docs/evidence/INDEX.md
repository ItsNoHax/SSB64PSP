...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — Fox, Mario/Luigi, and Samus closed; Link node-isolated, mesh/combiner conversion and pack.rs/psp_texture.rs packing both confirmed clean by live trace, root cause narrowed to the PSP runtime texture/CLUT bind path (psp/src/meshdraw.rs); Yoshi/Falcon/Ness/Pikachu/Kirby untraced. | texture, fighter, geometry, visual-regression, asset-pipeline |  |
