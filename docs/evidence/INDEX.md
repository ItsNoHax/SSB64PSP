...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — Fox, Mario/Luigi, and Samus closed; Link node-isolated, mesh/combiner conversion confirmed clean by live trace, root cause narrowed to pack-time texture serialization or PSP texture bind; Yoshi/Falcon/Ness/Pikachu/Kirby untraced. | texture, fighter, geometry, visual-regression, asset-pipeline |  |
