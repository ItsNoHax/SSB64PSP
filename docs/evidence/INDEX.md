...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — Fox, Mario/Luigi, and Samus closed; Link's boot defect confirmed on physical PSP hardware (real GE behavior for this texture's packed shape, not a stale bind, not PPSSPP-only) — fix vs. accepted-deviation still open; Yoshi/Falcon/Ness/Pikachu/Kirby untraced. | texture, fighter, geometry, visual-regression, asset-pipeline, hardware |  |
