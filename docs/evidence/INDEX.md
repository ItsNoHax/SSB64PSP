...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — Fox, Mario/Luigi, Samus, and Link (boot defect, fixed by bypassing PSP paletted-texture transport for that one texture, same class of fix as RE-267) closed; Yoshi/Falcon/Ness/Pikachu/Kirby untraced. | texture, fighter, geometry, visual-regression, asset-pipeline, hardware |  |
