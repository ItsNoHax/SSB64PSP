...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — Fox, Mario/Luigi, and Samus closed; Link node-isolated (combiner decoded, root cause not found); Yoshi/Falcon/Ness/Pikachu/Kirby untraced. | texture, fighter, geometry, visual-regression, asset-pipeline |  |
