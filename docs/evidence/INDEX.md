...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — 7/9 items closed (Fox, Mario/Luigi, Samus, Link boot, Link shin, Yoshi, Captain Falcon); Ness/Pikachu/Kirby untraced | texture, fighter, geometry, visual-regression, asset-pipeline |  |
