...
| RE-283 | Post-RE-281 texture/geometry defects survive across most playable fighters | IN_PROGRESS — defect catalog confirmed, root cause not yet found | texture, fighter, geometry, visual-regression, asset-pipeline |  |
