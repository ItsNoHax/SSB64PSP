...
Status: IN_PROGRESS — Fox's wrist defect is fully closed (live N64 capture).
Mario/Luigi's missing-button item is now closed on the same "own ROM-authored
state, correctly converted" bar RE-224/P0b-d's addressing work already
proved archive-wide (high confidence, no live-hardware capture taken this
follow-up). Samus's chest "black square" is now positively traced to node 12
in its real posed position (medium confidence, structurally consistent with
real ROM-authored dark shading, not yet exactly reconstructed or
hardware-checked); her thigh speckle does not reproduce at this camera
distance. Link, Yoshi, Captain Falcon, Ness, Pikachu, Kirby remain untraced.
...
**Confidence (Samus chest square, this follow-up): medium.** The node
