...
| Texture decode | 🟢 85% | `PLAN.md` R0.3 `COMPLETE`: RGBA16/32, IA4/8/16, I4/8, CI4/8 decoded, unit-tested; 679/706 bound textures packed (RE-160) | 27 unconverted, each root-caused and attributed elsewhere: 26 to R0.13, 1 to R0.7 |
