...
| Texture → PSP conversion | 🟡 97% / VERIFYING | ROM-backed conversion, mirror pre-baking, clamp/origin lowering and RE-201's Dream Land hardware capture are complete for their covered paths. Texgen's T1–T9 semantics/addressing/hardware work is complete (RE-225–237); only T10 (documentation and test-minimum cleanup) remains open. Current pack format is version 27. |
