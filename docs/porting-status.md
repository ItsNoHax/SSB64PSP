...
| PSP mesh drawing | 🟡 90% / VERIFYING | Indexed GE draws, CLUT textures, addressing, animation, alpha gates, runtime lighting and texgen are implemented and exercised in PPSSPP/physical-PSP scenes. RE-217 leaves raw-normal/LookAt texgen semantics, independent depth writes, submission order and full DrawState cache isolation open. |
