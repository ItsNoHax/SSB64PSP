...
| Texture → PSP conversion | COMPLETE for measured renderer scope | Mirror/clamp/origin/signed-coordinate lowering, palette banks, texgen T1–T10, and PSP sample-centre lowering are measured and complete. Pack format v30 | RE-201, RE-219–239, RE-262–269, RE-301, RE-304 | N64 3-point filtering vs PSP bilinear remains an accepted fixed-function deviation; compensation was deliberately not added | R0.5, R2.0 |
