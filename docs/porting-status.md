...
| Asset pack format | COMPLETE | Zero-copy, 16-byte aligned, little-endian; writer + reader unit-tested. v30 carries animation, per-MObj material UV rest state, lighting, rest transforms, LBParticle, alpha-compare, texgen, independent depth state, signed-clamp UV marker | RE-301 | — | M2 |
| PSP asset loading | COMPLETE on PSP-2000/3000/Slim | Current v30 pack loads in PPSSPP; the aligned/cache-flushed v29 pack (26,254,608 B) and `MEMSIZE=1` were physically proven | RE-256, RE-260, RE-301 | PSP-1000's 32 MiB compatibility unresolved (can't use `MEMSIZE=1`); the v30 material-animation pack has not had a separate hardware capture | R2 |
