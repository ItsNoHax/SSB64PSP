...
| Texture → PSP conversion | COMPLETE for measured renderer scope | Mirror/clamp/origin/signed-coordinate lowering, palette banks, texgen T1–T10, PSP sample-centre lowering, and selective build-time 3-point compensation (material-aware on alpha; CI4/CI8 candidates now use filter-aware coordinate-descent index optimization instead of nearest-palette-color quantization, RE-307) are measured and complete. Pack format v30 | RE-201, RE-219–239, RE-262–269, RE-301, RE-304–307 | Exact 3-point equality remains impossible with fixed-function bilinear; compensated immutable variants reduce measured error and leave already-good/animation-sensitive textures unchanged | R0.5, R2.0 |
