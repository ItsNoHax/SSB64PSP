...
| Texture → PSP conversion | COMPLETE for measured renderer scope | Mirror/clamp/origin/signed-coordinate lowering, palette banks, texgen T1–T10 gate all complete. Pack format v30 | RE-201, RE-219–239, RE-262–269, RE-301 | N64 3-point filtering vs PSP bilinear is an accepted fixed-function deviation (RE-219) | R0.5, R2.0 |
